...
from ..core.models import HealthMetric, UserProfile, DailyPlan, ChatMessage
...
class StateStoreAgent:
    ...
    async def store_daily_plan(self, plan: DailyPlan) -> None:
        ...
        """, (
            ...
            json.dumps([meal.dict() if hasattr(meal, 'dict') else meal for meal in plan.suggested_meals]),
            plan.plan_reasoning,
