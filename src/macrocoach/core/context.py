...
class ApplicationContext:
    ...
    database_url: str = field(
        default_factory=lambda: os.getenv("DATABASE_URL", "sqlite:///./macrocoach.db")
    )
    ...
    # Feature flags
    healthkit_enabled: bool = field(
        default_factory=lambda: os.getenv("APPLE_HEALTHKIT_ENABLED", "false").lower()
        == "true"
    )
    health_connect_enabled: bool = field(
        default_factory=lambda: os.getenv(
            "ANDROID_HEALTH_CONNECT_ENABLED", "false"
        ).lower()
        == "true"
    )
    miband_enabled: bool = field(
        default_factory=lambda: os.getenv("XIAOMI_MIBAND_ENABLED", "false").lower()
        == "true"
    )
